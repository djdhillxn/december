...
def arg_parser():
    ...
    parser.add_argument("--train_path", type=str, default="./data/words_250000_train.txt",
...
class HangmanGame(object):
    def __init__(self, train_set_path, model_path="./saved_models/model.pth", n_gram=2):
